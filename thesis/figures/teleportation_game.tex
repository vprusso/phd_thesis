...
\begin{document}
	...
	\begin{center}
		\begin{tikzpicture}[text depth=1pt,bend angle=45]
			...
			\node[AB] (A-1) at (6,2.5) {\small $A$};
			\node[AB] (B-1) at (6,-2.5) {\small $B$};
			\node[AB] (sig) at (-3,0) {\small $\sigma$};	

			\draw[double,thick] (9.5,0) to (10,0); 

			\draw[-,thick] (-2.7,1.25) to node[above] {$\reg{X}_1$} (2.5,1.25);
			\draw[-,thick] (-2.7,1.25) to (-2.7,0.6);
			
			\draw[-,thick] (-2.7,-1.25) to node[above] {$\reg{Y}_1$} (2.5,-1.25);
			\draw[-,thick] (-2.7,-1.25) to (-2.7,-0.6);			
			...
			\draw[-,thick] (-3,-0.6) to (-3,-3.1); 
			\draw[-,thick] (-3,3.1) to node[above] {$\reg{U}$} (5.5,3.1);
			\draw[-,thick] (-3,-3.1) to node[above] {$\reg{V}$} (5.5,-3.1);
			...
			\draw [dashed] (0.2,1.5) -- (9,1.5);
			\draw [dashed] (0.2,-1.6) -- (9,-1.6);
