...
\begin{document}
		\begin{tikzpicture}[text depth=1pt,bend angle=45]
		  ...
		  \node[AB] (sig) at (-2, 0) {\small $\sigma$};
			...
			\draw[-,thick] (-2,0.5) to (-2,2.4) {};
			\draw[-,thick] (-2,2.4) to node[above] {$\reg{U}$} (2.5,2.4);
			
			\draw[-,thick] (-2,-0.5) to (-2,-2.4) {};
			\draw[-,thick] (-2,-2.4) to node[above] {$\reg{V}$} (2.5,-2.4);
			
										
			\draw[-,thick] (0.5,0.5) [out=90,in=180] to [out=0,in=180] node[above] {$\reg{X}$} (2.5,2);
			\draw[-,thick] (0.5,-0.5) [out=90,in=180] to [out=0,in=180] node[above] {$\reg{Y}$} (2.5,-2);			
			
			\draw[-,thick] (Ref-0) to node[above]{$\reg{S}$} (Ref-1);
			
			\draw[-,double,thick] (Ref-1) to (7,0);
