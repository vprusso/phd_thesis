...
\begin{document}
	...
	\begin{center}
		\begin{tikzpicture}[decoration=zigzag,scale=0.5,transform shape]
  		% ellipses
  		\filldraw[fill=gray!10, draw=gray!80] (4.8,0) ellipse (6.4cm and 3.2cm);
  		\filldraw[fill=gray!20, draw=gray!80] (3.2,0) ellipse (4.8cm and 2.4cm);
  		\filldraw[fill=gray!30, draw=gray!80, dotted, thick] (1.6,0) ellipse (3.2cm and 1.6cm);
  		\filldraw[fill=gray!40, draw=gray!80] (0,0) ellipse (1.6cm and 0.8cm) node {$\omega_c(G)$};
	\node at (3.2,0) {\huge{$\cdots$}};  			
	\node at (6.4,0) {$\omega^2_c(G)$};
	\node at (9.6,0) {$\omega^1_c(G)$};
		\end{tikzpicture}
	\end{center}
