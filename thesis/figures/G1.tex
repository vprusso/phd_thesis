...
\begin{document}
	...
	\begin{center}
		\begin{tikzpicture}[text depth=1pt,bend angle=45]
			...
			\draw[-,thick] (0.5,3.1) to node[above] {$\reg{C}$} (5.5,3.1);			
			\draw[-,thick] (0.5,-3.1) to node[above] {$\reg{D}$} (5.5,-3.1);
			
			\draw[-,thick] (-3,0.6) to (-3,3.1); 
			\draw[-,thick] (-3,-0.6) to (-3,-3.1); 
			\draw[-,thick] (-3,3.1) to node[above] {$\reg{A}$} (-0.5,3.1);
			\draw[-,thick] (-3,-3.1) to node[above] {$\reg{B}$} (-0.5,-3.1);
